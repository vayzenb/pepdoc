...
stim_folder = "/user_data/vayzenbe/GitHub_Repos/pepdoc/stim/binary2"
out_folder = "/user_data/vayzenbe/GitHub_Repos/pepdoc/stim/"
...
os.makedirs(f'{out_folder}/crops/', exist_ok = True)
...
for imf in imfiles:
    ...
    print(curr_file)
    if os.path.exists(f'{out_folder}/blur/{curr_file}.jpg'):
        continue
    else:
        im = io.imread(imf)
        #pdb.set_trace()
        ...
        io.imsave(f'{out_folder}/crops/{curr_file}.jpg',silh)
